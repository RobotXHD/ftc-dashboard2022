...
@Autonomous
@Disabled
public class Inclinat_Albastru_Fata extends LinearOpMode {
    ...
    public Thread Autonom = new Thread(new Runnable(){
        ...
        public void run() {
            if(varrez=="Stanga"&&!isStopRequested()) {
                ...
                while(lastTime + 600 > System.currentTimeMillis()){}
                Translatare(0,-50,1);
                Translatare(100,-117,1);
                lastTime = System.currentTimeMillis();
                while(lastTime + 100 > System.currentTimeMillis()){}
                Translatare(0,-25,0.5);
                DJR.setPower(-0.5);
                lastTime = System.currentTimeMillis();
                while(lastTime + 2300 > System.currentTimeMillis()){}
                DJR.setPower(0);
                Rotire(142,1);
                lastTime = System.currentTimeMillis();
                while(lastTime + 6000 > System.currentTimeMillis()){}
                Translatare(0,480,1);
                lastTime = System.currentTimeMillis();
                while(lastTime + 800 > System.currentTimeMillis()){}
                Translatare(140,0,1);*/
            }
            if(varrez == "Mijloc"&&!isStopRequested()) {
                ...
                Rotire(150,1);
                lastTime = System.currentTimeMillis();
                while(lastTime + 6500 > System.currentTimeMillis()){}
                Translatare(0,480,1);
                lastTime = System.currentTimeMillis();
                while(lastTime + 800 > System.currentTimeMillis()){}
                Translatare(140,0,1);*/
