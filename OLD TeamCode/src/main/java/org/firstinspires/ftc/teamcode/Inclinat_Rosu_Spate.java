...
@Autonomous
@Disabled
public class Inclinat_Rosu_Spate extends LinearOpMode {
    ...
    public Thread Autonom = new Thread(new Runnable(){
        ...
        public void run() {
            ...
            if(varrez == "Stanga"&&!isStopRequested()) {
                ...
                arm.setPower(1);
                while(arm.isBusy());
                arm.setPower(0);                arm.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
