...
@Autonomous
public class OpenCV_playground extends LinearOpMode {
    ...
    // Pink Range                                      Y      Cr     Cb
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 150.0, 170.0);
    public static Scalar scalarUpperYCrCb = new Scalar(60.0, 255.0, 255.0);
