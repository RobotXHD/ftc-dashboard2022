...
public class FreightF extends OpMode{
    ...
    public void init() {
        ...
        crosa             = hardwareMap.servo.get("crosa");
 ...
 */
                ...
                if(gamepad2.b)
                {
                    crosa.setPosition(1.0);
                }

                if(gamepad2.x)
                {
                    crosa.setPosition(0.0);
                }
...
/*if (gamepad1.a){
    if(!power && time + 500 < System.currentTimeMillis())
    {power =! power; motor.setPower(1); time=System.currentTimeMillis();}
    else if (power && time + 500 < System.currentTimeMillis()){ power =! power; motor.setPower(0); time=System.currentTimeMillis();}
}*/
